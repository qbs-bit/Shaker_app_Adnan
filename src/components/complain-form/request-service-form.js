...
import { View, ScrollView, Text, StyleSheet, ImageBackground, Image, TouchableOpacity, TextInput, Button } from 'react-native';
...
const RequestServiceForm = ({ navigation }) => {
    ...
    //Note: function to show date picker
    const showDatePicker = () => {
        setIsDatePickerVisible(true);
    }
    //Note: function to hide date picker
    ...
    const toServiceTicket = () => {
        navigation.navigate('Service Num')
    }
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={styles.mainContainer}>
                        ...
                        <View style={styles.mainBtnContainer}>
                            <TouchableOpacity style={styles.btnContainer} onPress={toServiceTicket}>
