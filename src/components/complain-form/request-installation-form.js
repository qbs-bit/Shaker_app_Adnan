...
const RequestInstallationForm = ({ navigation }) => {
    ...
    const toInstallTicket = () => {
        navigation.navigate('Install Num')
    }
                ...
                <ScrollView showsVerticalScrollIndicator={false}>
                    <View style={styles.mainContainer}>
                        ...
                        <View style={styles.mainBtnContainer}>
                            <TouchableOpacity style={styles.btnContainer} onPress={toInstallTicket}>
