                ...
                <ScrollView>
                    <View style={styles.mainContainer}>
                        <View style={styles.headingContainer}>
                            <Text style={styles.mainHeading}>Hi, Sameer</Text>
                        ...
                        <View style={styles.subContainer}>
                            <TouchableOpacity onPress={() => Linking.openURL('https://www.shaker.com.sa/')}>
                                <View style={styles.boxContainer}>
                        ...
                        <View style={styles.btnContainer }>
                            <TouchableOpacity style={ styles.btnStyle } onPress={toPendingCases}>
                                <Text style={styles.btnText}>Pending Cases</Text>
                            </TouchableOpacity>
