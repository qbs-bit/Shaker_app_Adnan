            ...
            <ImageBackground source={require('../../../assets/images/homebg.png')} style={styles.bgImg}>
                ...
                <View style={styles.mainContainer}>
                    <View style={styles.boxContainer}>
                        ...
                        <Text style={styles.heading}>Your Request Number</Text>
                        <Text style={styles.complainNum}>012345</Text>
                        <Text style={styles.tyText}>Thanks for your Request</Text>
                        <Text style={styles.responseText}>Our team will contact you soon</Text>
